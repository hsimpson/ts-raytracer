...
var hamt_1 = createCommonjsModule(function(module) {
  ...
  var updateCollisionList = function updateCollisionList2(mutate2, edit, keyEq, h, list, f2, k2, size) {
    ...
    if (newValue === nothing)
      return list;
    ++size.value;
    return arrayUpdate(mutate2, len2, Leaf(edit, h, k2, newValue), list);
  };
  var canEditNode = function canEditNode2(edit, node) {
    return edit === node.edit;
  };
  var Leaf__modify = function Leaf__modify2(edit, keyEq, shift, f2, h, k2, size) {
  ...
  var Collision__modify = function Collision__modify2(edit, keyEq, shift, f2, h, k2, size) {
    if (h === this.hash) {
  ...
  var IndexedNode__modify = function IndexedNode__modify2(edit, keyEq, shift, f2, h, k2, size) {
    var mask = this.mask;
  ...
  var ArrayNode__modify = function ArrayNode__modify2(edit, keyEq, shift, f2, h, k2, size) {
    var count2 = this.size;
    var children = this.children;
    var frag = hashFragment(shift, h);
    var child = children[frag];
    var newChild = (child || empty)._modify(edit, keyEq, shift + SIZE, f2, h, k2, size);
    if (child === newChild)
      return this;
    var canEdit = canEditNode(edit, this);
    var newChildren = void 0;
  ...
  var lazyVisitChildren = function lazyVisitChildren2(len2, children, i, f2, k2) {
    while (i < len2) {
      var child = children[i++];
      if (child && !isEmptyNode(child))
        return lazyVisit(child, f2, [len2, children, i, f2, k2]);
    }
    return appk(k2);
  };
...
function useRecoilInterface_DEPRECATED() {
  ...
  useEffect$3(() => {
    ...
    Recoil_differenceSets(recoilValuesUsed.current, previousSubscriptions.current).forEach((key) => {
      ...
      const sub2 = subscribeToRecoilValue$1(store, new AbstractRecoilValue$3(key), (state2) => updateState(state2, key), componentName);
  ...
  useEffect$3(() => {
    ...
    Recoil_differenceSets(recoilValuesUsed.current, new Set(currentSubscriptions.keys())).forEach((key) => {
      const sub2 = subscribeToRecoilValue$1(storeRef.current, new AbstractRecoilValue$3(key), (state) => updateState(state, key), componentName);
      currentSubscriptions.set(key, sub2);
    });
...
class HitRecord {
  ...
  setFaceNormal(r2, outward_normal) {
    this.frontFace = dot(r2.direction, outward_normal) < 0;
...
class Ray {
  ...
  at(t2) {
    return add(create$2(), this._orig, scale$1(create$2(), this._dir, t2));
  }
}
...
function getSphereUV(p2) {
  ...
  const u2 = 1 - (phi + Math.PI) / (2 * Math.PI);
  const v2 = (theta + Math.PI / 2) / Math.PI;
  return { u: u2, v: v2 };
}
function lengthSquared(v2) {
  return v2[0] ** 2 + v2[1] ** 2 + v2[2] ** 2;
}
function reflect(v2, n2) {
  return subtract(create$2(), v2, scale$1(create$2(), n2, 2 * dot(v2, n2)));
}
function refract(uv, n2, etai_over_etat) {
  const cos_theta = dot(negate(create$2(), uv), n2);
  const uvTheta = add(create$2(), uv, scale$1(create$2(), n2, cos_theta));
  const r_out_parallel = scale$1(create$2(), uvTheta, etai_over_etat);
  const r_out_perp = scale$1(create$2(), n2, -Math.sqrt(1 - lengthSquared(r_out_parallel)));
...
function randomUnitVector() {
  ...
  const z2 = randomNumberRange(-1, 1);
  const r2 = Math.sqrt(1 - z2 * z2);
  return [r2 * Math.cos(a), r2 * Math.sin(a), z2];
}
...
let Camera = class {
  ...
  init(lookFrom, lookAt, vUp, fovY, aspectRatio, aperture, focusDist, t0 = 0, t1 = 0) {
    ...
    scale$1(this.horizontal, this.u, focusDist * viewport_width);
    scale$1(this.vertical, this.v, focusDist * viewport_height);
    const half_horizontal = scale$1(create$2(), this.horizontal, 0.5);
    const half_vertical = scale$1(create$2(), this.vertical, 0.5);
    const focusW = scale$1(create$2(), this.w, focusDist);
    subtract(
  ...
  getRay(s, t2) {
    const rd2 = scale$1(create$2(), randomInUnitdisk(), this.lenseRadius);
    const vecU = scale$1(create$2(), this.u, rd2[0]);
    const vecV = scale$1(create$2(), this.v, rd2[1]);
    const offset = add(create$2(), vecU, vecV);
    const sHor = scale$1(create$2(), this.horizontal, s);
    const tVer = scale$1(create$2(), this.vertical, t2);
    return new Ray(
...
let Transform = class {
  ...
  transformRay(ray) {
    ...
    const movedOrigin = fromValues$1(ray.origin[0], ray.origin[1], ray.origin[2]);
    transformMat4(movedOrigin, movedOrigin, this._worldToObjectMatrix);
    const movedDirection = fromValues$1(ray.direction[0], ray.direction[1], ray.direction[2]);
  ...
  transformRecord(ray, rec) {
    ...
    const movedP = fromValues$1(rec.p[0], rec.p[1], rec.p[2]);
    transformMat4(movedP, movedP, this._objectToWorldMatrix);
    const movedN = fromValues$1(rec.normal[0], rec.normal[1], rec.normal[2]);
...
let XYRect = class extends Hittable {
  constructor(x0, x1, y0, y1, k2, material) {
    super();
  ...
  hit(ray, tMin, tMax, rec) {
    ...
    const t2 = (this.k - transformedRay.origin[2]) / transformedRay.direction[2];
    if (t2 < tMin || t2 > tMax) {
      return false;
    }
    const x2 = transformedRay.origin[0] + t2 * transformedRay.direction[0];
    const y2 = transformedRay.origin[1] + t2 * transformedRay.direction[1];
    if (x2 < this.x0 || x2 > this.x1 || y2 < this.y0 || y2 > this.y1) {
      return false;
    }
    rec.u = (x2 - this.x0) / (this.x1 - this.x0);
    rec.v = (y2 - this.y0) / (this.y1 - this.y0);
    rec.t = t2;
    const outwardNormal = [0, 0, 1];
    rec.setFaceNormal(transformedRay, outwardNormal);
    rec.mat = this.material;
    rec.p = transformedRay.at(t2);
...
let XZRect = class extends Hittable {
  constructor(x0, x1, z0, z1, k2, material) {
    super();
    __publicField(this, "x0");
    __publicField(this, "x1");
  ...
  hit(ray, tMin, tMax, rec) {
    const transformedRay = this.transform.transformRay(ray);
    const t2 = (this.k - transformedRay.origin[1]) / transformedRay.direction[1];
    if (t2 < tMin || t2 > tMax) {
      return false;
    }
    const x2 = transformedRay.origin[0] + t2 * transformedRay.direction[0];
    const z2 = transformedRay.origin[2] + t2 * transformedRay.direction[2];
    if (x2 < this.x0 || x2 > this.x1 || z2 < this.z0 || z2 > this.z1) {
      return false;
    }
    rec.u = (x2 - this.x0) / (this.x1 - this.x0);
    rec.v = (z2 - this.z0) / (this.z1 - this.z0);
    rec.t = t2;
...
let YZRect = class extends Hittable {
  constructor(y0, y1, z0, z1, k2, material) {
    super();
    __publicField(this, "y0");
    __publicField(this, "y1");
    __publicField(this, "z0");
  ...
  hit(ray, tMin, tMax, rec) {
    const transformedRay = this.transform.transformRay(ray);
    const t2 = (this.k - transformedRay.origin[0]) / transformedRay.direction[0];
    if (t2 < tMin || t2 > tMax) {
      return false;
    }
    const y2 = transformedRay.origin[1] + t2 * transformedRay.direction[1];
    const z2 = transformedRay.origin[2] + t2 * transformedRay.direction[2];
    if (y2 < this.y0 || y2 > this.y1 || z2 < this.z0 || z2 > this.z1) {
      return false;
    }
    rec.u = (y2 - this.y0) / (this.y1 - this.y0);
    rec.v = (z2 - this.z0) / (this.z1 - this.z0);
    rec.t = t2;
...
let CheckerTexture = class extends Texture {
  ...
  value(u2, v2, p2) {
    const x2 = this.modulo(u2 * this._scale) < 0.5;
    const y2 = this.modulo(v2 * this._scale) < 0.5;
    if (x2 ? !y2 : y2) {
      return this._even.value(u2, v2, p2);
    } else {
      return this._odd.value(u2, v2, p2);
    }
  }
  get odd() {
...
const alea = /* @__PURE__ */ getDefaultExportFromCjs(aleaExports);
const F3 = 1 / 3;
const G3 = 1 / 6;
const fastFloor = (x2) => Math.floor(x2) | 0;
...
function createNoise3D(random2 = Math.random) {
  const perm = buildPermutationTable(random2);
  const permGrad3x = new Float64Array(perm).map((v2) => grad3[v2 % 12 * 3]);
  const permGrad3y = new Float64Array(perm).map((v2) => grad3[v2 % 12 * 3 + 1]);
  const permGrad3z = new Float64Array(perm).map((v2) => grad3[v2 % 12 * 3 + 2]);
  return function noise3D2(x2, y2, z2) {
    let n0, n1, n2, n3;
    const s = (x2 + y2 + z2) * F3;
    const i = fastFloor(x2 + s);
    const j = fastFloor(y2 + s);
    const k2 = fastFloor(z2 + s);
    const t2 = (i + j + k2) * G3;
    const X0 = i - t2;
    const Y0 = j - t2;
    const Z0 = k2 - t2;
    ...
    if (t0 < 0)
      ...
      const gi0 = ii2 + perm[jj2 + perm[kk2]];
      t0 *= t0;
    ...
    if (t1 < 0)
      ...
      const gi1 = ii2 + i1 + perm[jj2 + j1 + perm[kk2 + k1]];
      t1 *= t1;
    ...
    if (t22 < 0)
      ...
      const gi2 = ii2 + i2 + perm[jj2 + j2 + perm[kk2 + k22]];
      t22 *= t22;
      n2 = t22 * t22 * (permGrad3x[gi2] * x22 + permGrad3y[gi2] * y22 + permGrad3z[gi2] * z22);
    }
    let t3 = 0.6 - x3 * x3 - y3 * y3 - z3 * z3;
    if (t3 < 0)
      n3 = 0;
    else {
      const gi3 = ii2 + 1 + perm[jj2 + 1 + perm[kk2 + 1]];
      t3 *= t3;
...
let Perlin = class {
  ...
  noise(p2) {
    let u2 = p2[0] - Math.floor(p2[0]);
    let v2 = p2[1] - Math.floor(p2[1]);
    let w2 = p2[2] - Math.floor(p2[2]);
    u2 = u2 * u2 * (3 - 2 * u2);
    v2 = v2 * v2 * (3 - 2 * v2);
    w2 = w2 * w2 * (3 - 2 * w2);
    const i = Math.floor(p2[0]);
    const j = Math.floor(p2[1]);
    const k2 = Math.floor(p2[2]);
    const c = [
      [[], []],
      [[], []]
    ];
...
function trilinearInterp(c, u2, v2, w2) {
  const uu = u2 * u2 * (3 - 2 * u2);
  const vv = v2 * v2 * (3 - 2 * v2);
  const ww = w2 * w2 * (3 - 2 * w2);
  let accum = 0;
  for (let i = 0; i < 2; i++) {
    for (let j = 0; j < 2; j++) {
      for (let k2 = 0; k2 < 2; k2++) {
        const weight = [u2 - i, v2 - j, w2 - k2];
        accum += (i * uu + (1 - i) * (1 - uu)) * (j * vv + (1 - j) * (1 - vv)) * (k2 * ww + (1 - k2) * (1 - ww)) * dot(c[i][j][k2], weight);
      }
    }
  }
  return accum;
...
let NoiseTexture = class extends Texture {
  ...
  turb(p2, depth = 7) {
    ...
    let weight = 1;
    for (let i = 0; i < depth; i++) {
      accum += weight * noise3D(p2[0], p2[1], p2[2]);
      weight *= 0.5;
      scale$1(tempP, tempP, 2);
    }
    return Math.abs(accum);
  }
  value(u2, v2, p2) {
    return scale$1(
      create$2(),
      scale$1(create$2(), fromValues$1(1, 1, 1), 0.5),
      1 + Math.sin(this._scale * p2[2] + 10 * this.turb(p2))
    );
  }
};
...
let DiffuseLight = class extends Material {
  ...
  emitted(u2, v2, p2) {
    return this._emit.value(u2, v2, p2);
  }
};
...
let NormalMaterial = class extends Material {
  ...
  scatter(ray, rec, attenuation, scattered) {
    ...
    if (this.corrected) {
      add(col, col, fromValues$1(1, 1, 1));
      scale$1(col, col, 0.5);
      normalize$2(col, col);
    }
    copy(attenuation, col);
...
let UVMaterial = class extends Material {
  scatter(ray, rec, attenuation, scattered) {
    const scatter_direction = add(create$2(), rec.normal, randomUnitVector());
    new Ray(rec.p, scatter_direction, ray.time).copyTo(scattered);
    const col = fromValues$1(rec.u, rec.v, 0);
    copy(attenuation, col);
    return true;
  }
};
...
let ConstantMedium = class extends Hittable {
  ...
  hit(r2, t_min, t_max, rec) {
    const rec1 = new HitRecord();
    const rec2 = new HitRecord();
    if (!this._boundary.hit(r2, Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY, rec1)) {
      return false;
    }
    if (!this._boundary.hit(r2, rec1.t + 1e-4, Number.POSITIVE_INFINITY, rec2)) {
      return false;
    }
    if (rec1.t < t_min) {
      rec1.t = t_min;
    ...
    const rayLength = length(r2.direction);
...
let MovingSphere = class extends Hittable {
  ...
  hit(ray, tMin, tMax, rec) {
    const transformedRay = this.transform.transformRay(ray);
    const oc2 = subtract(create$2(), transformedRay.origin, this.center(transformedRay.time));
    const a = lengthSquared(transformedRay.direction);
    const half_b = dot(oc2, transformedRay.direction);
    const c = lengthSquared(oc2) - this._radius * this._radius;
    const discriminat = half_b * half_b - a * c;
    if (discriminat > 0) {
      const root2 = Math.sqrt(discriminat);
      let temp = (-half_b - root2) / a;
      if (temp < tMax && temp > tMin) {
        ...
        scale$1(outward_normal, pMinusCenter, 1 / this._radius);
  ...
  center(time) {
    ...
    const centerDiffT = scale$1(create$2(), centerDiff, timeDiff);
...
let Sphere = class extends Hittable {
  ...
  hit(ray, tMain, tMax, rec) {
    const transformedRay = this.transform.transformRay(ray);
    const oc2 = subtract(create$2(), transformedRay.origin, this._center);
    const a = lengthSquared(transformedRay.direction);
    const half_b = dot(oc2, transformedRay.direction);
    const c = lengthSquared(oc2) - this._radius * this._radius;
    const discriminat = half_b * half_b - a * c;
  ...
  boundingBox(_t0, _t1) {
    ...
    const r2 = fromValues$1(this._radius, this._radius, this._radius);
    return new AABB(sub(create$2(), transformedCenter, r2), add(create$2(), transformedCenter, r2));
  }
};
...
function avgVector3(vectors) {
  ...
  return [x2 / vectors.length, y2 / vectors.length, z2 / vectors.length];
}
const EPSILON = 1e-8;
let Triangle = class extends Hittable {
  ...
  hit(ray, tMin, tMax, rec) {
    ...
    if (!this.doubleSided) {
      ...
      v2 = dot(transformedRay.direction, qvec);
      if (v2 < 0 || u2 + v2 > det) {
        return false;
      }
      t2 = dot(edge2, qvec);
      ...
      const invDet = 1 / det;
      const tvec = subtract(create$2(), transformedRay.origin, this.v0);
      u2 = dot(tvec, pvec) * invDet;
      if (u2 < 0 || u2 > 1) {
        return false;
      }
      const qvec = cross(create$2(), tvec, edge1);
      v2 = dot(transformedRay.direction, qvec) * invDet;
      if (v2 < 0 || u2 + v2 > 1) {
        return false;
      }
      t2 = dot(edge2, qvec);
    ...
    rec.mat = this.material;
    const w2 = 1 - u2 - v2;
    const n0 = scale$1(create$2(), this.n0, w2);
    const n1 = scale$1(create$2(), this.n1, u2);
    const n2 = scale$1(create$2(), this.n2, v2);
...
class RaytracerBase {
  constructor() {
    ...
    __publicField(this, "_rayTracerOptions");
    __publicField(this, "_doneCallback");
  }
...
async function load(url) {
  ...
  for (const material of materials) {
    ...
    if (!baseColor) {
      baseColor = fromValues(0.5, 0.5, 0.5, 1);
    }
    let mat;
    if (material.emissiveFactor) {
      const emissiveColor = scale(create$1(), baseColor, 50);
      mat = new DiffuseLight(fromValues$1(emissiveColor[0], emissiveColor[1], emissiveColor[2]));
    } else {
...
function randomScene(useBVH) {
  ...
  for (let a = -count; a < count; a++) {
    for (let b = -count; b < count; b++) {
      ...
      if (length(sub(create$2(), center, [4, 0.2, 0])) > 0.9) {
        let sphereMaterial;
        if (chooseMat < 0.8) {
          const albedo = multiply$1(create$2(), random(), random());
          sphereMaterial = new LambertianMaterial(albedo);
          const center2 = add(create$2(), center, [0, randomNumberRange(0, 1), 0]);
  ...
  const cameraOptions = { ...defaultCameraOptions, lookFrom: [13, 2, 3], fovY: 20 };
  if (useBVH) {
...
async function finalScene(useBVH) {
  ...
  const center2 = add(create$2(), center1, [30, 0, 0]);
...
async function gltfScene(useBVH) {
  const world = await load("assets/models/scene.gltf");
  const lookFrom = [2, 1.5, 6];
  const lookAt = [0, 0, 0];
  const fovY = 20;
  const background = [0.7, 0.8, 1];
  const cameraOptions = { ...defaultCameraOptions, lookFrom, lookAt, fovY, background };
  if (useBVH) {
    return {
...
function createComputeTiles(imageWidth, imageHeight, tileSize) {
  const computeTiles = [];
  for (let y2 = 0; y2 < imageHeight; y2 += tileSize) {
    for (let x2 = 0; x2 < imageWidth; x2 += tileSize) {
      computeTiles.push({
        x: x2,
        y: y2,
        width: x2 + tileSize < imageWidth ? tileSize : imageWidth - x2,
        height: y2 + tileSize < imageHeight ? tileSize : imageHeight - y2
      });
    }
  }
  return computeTiles;
...
class RaytracerCPU extends RaytracerBase {
  constructor(rayTracerCPUOptions) {
    super();
    __publicField(this, "_controllerWorker", new WorkerWrapper());
    __publicField(this, "_context2D");
    __publicField(this, "_computeWorkers", /* @__PURE__ */ new Map());
    __publicField(this, "_computeTiles", []);
    __publicField(this, "_imageArray");
  ...
  updateImage() {
    ...
    for (let y2 = this._rayTracerOptions.imageHeight - 1; y2 >= 0; y2--) {
      for (let x2 = 0; x2 < this._rayTracerOptions.imageWidth; x2++) {
        const imageIndex = (y2 * this._rayTracerOptions.imageWidth + x2) * 4;
...
const _WebGPUContext = class _WebGPUContext {
  static createContext(device, queue, context) {
    ...
    _WebGPUContext._context = context;
  }
  static get device() {
    return _WebGPUContext._device;
  }
  static get queue() {
    return _WebGPUContext._queue;
  }
  static get context() {
...
class RaytracingBuffers {
  constructor(world) {
    __publicField(this, "_gpuMaterials", []);
    __publicField(this, "_gpuPrimitives", []);
    __publicField(this, "_gpuTextures", []);
    __publicField(this, "_textureSize", 2);
    __publicField(this, "_imageTextures", []);
    this.traverseHittables(world, create$3());
  }
  ...
  traverseHittables(list, objectToWorld) {
    for (const object of list.objects) {
      ...
      multiply$2(currentObjectToWorld, objectToWorld, currentObjectToWorld);
      if (object instanceof HittableList) {
  ...
  addTexture(tex) {
    ...
    if (tex instanceof SolidColor) {
      gpuTex.color = fromValues(tex.color[0], tex.color[1], tex.color[2], 1);
      gpuTex.textureType = 0;
    } else if (tex instanceof CheckerTexture) {
      gpuTex.checkerOdd = fromValues(tex.odd[0], tex.odd[1], tex.odd[2], 1);
      gpuTex.checkerEven = fromValues(tex.even[0], tex.even[1], tex.even[2], 1);
  ...
  addMaterial(mat) {
    ...
    if (mat instanceof LambertianMaterial) {
      ...
      gpuMat = {
        baseColor: fromValues(mat.baseColor[0], mat.baseColor[1], mat.baseColor[2], 1),
  ...
  addPrimitive(obj, objectToWorld) {
    ...
    if (obj instanceof Sphere) {
      gpuPrimitive = {
        objectToWorld,
        center0: fromValues(obj.center[0], obj.center[1], obj.center[2], 0),
        center1: [0, 0, 0, 1],
        radius: obj.radius,
        ...rectDummy,
        ...triangleDummy,
      ...
      gpuPrimitive = {
        objectToWorld,
        center0: fromValues(obj.center0[0], obj.center0[1], obj.center0[2], obj.time0),
        center1: fromValues(obj.center1[0], obj.center1[1], obj.center1[2], obj.time1),
        radius: obj.radius,
        ...rectDummy,
        ...triangleDummy,
        primitiveType: 1,
  ...
  primitiveBuffer() {
    ...
    for (const primitiv of this._gpuPrimitives) {
      const inverseMatrix = invert(create$3(), primitiv.objectToWorld);
      const rotation = getRotation(create(), primitiv.objectToWorld);
      const inverseRotation = invert(create$3(), fromQuat(create$3(), rotation));
...
class WebGPUPipelineBase extends WebGPUObjectBase {
  constructor() {
    ...
    __publicField(this, "_pipeline");
    __publicField(this, "_bindGroupLayout");
    __publicField(this, "_bindGroup");
  }
  prepareCode(code) {
...
class WebGPUComputePipline extends WebGPUPipelineBase {
  constructor(options) {
    ...
    __publicField(this, "_raytracingBuffers");
    __publicField(this, "_computeParamsUniformBuffer", new WebGPUBuffer());
    __publicField(this, "_computeCameraUniformBuffer", new WebGPUBuffer());
    __publicField(this, "_pixelBuffer", new WebGPUBuffer());
    __publicField(this, "_accumulationBuffer", new WebGPUBuffer());
    __publicField(this, "_primitivesBuffer", new WebGPUBuffer());
    __publicField(this, "_materialsBuffer", new WebGPUBuffer());
    __publicField(this, "_texturesBuffer", new WebGPUBuffer());
...
class WebGPURenderPipeline extends WebGPUPipelineBase {
  constructor(options) {
    super();
    __publicField(this, "_options");
    __publicField(this, "_vertexPositionBuffer", new WebGPUBuffer());
    // private _vertexColorBuffer = new WebGPUBuffer();
    __publicField(this, "_renderParamsUniformBuffer", new WebGPUBuffer());
    this._options = options;
  }
  async initialize() {
    if (this._initialized) {
...
class RaytracerGPU extends RaytracerBase {
  ...
  constructor(rayTracerGPUOptions) {
    super();
    __publicField(this, "_initialized", false);
    __publicField(this, "_presentationFormat");
...
const RaytracerProperties = Recoil_index_8({
...
const RaytracerRunningState = Recoil_index_8({
  key: "raytracerState",
  default: {
    isRunning: false,
    stats: ""
...
const Canvas = () => {
  ...
  const [raytracerState] = Recoil_index_22(RaytracerProperties);
  const [raytracerRunningState, setRaytracerRunningState] = Recoil_index_22(RaytracerRunningState);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "render-container", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "stats", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: `Render stats: ${raytracerRunningState.stats}` }) }),
...
const CheckBox = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "checkbox", disabled: props.disabled, checked: props.checked, onChange: onInputChange }),
...
const DropDown = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dropdown", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: props.label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("select", { defaultValue: props.default, onChange: onSelectChange, children: props.items.map((item) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: item.value, disabled: item.disabled, children: item.text }, item.value);
    }) })
  ] });
};
const Gui = () => {
  const [raytracerState, setRaytracerState] = Recoil_index_22(RaytracerProperties);
  const resetRaytracerState = Recoil_index_25(RaytracerProperties);
  const [raytracerRunningState, setRaytracerRunningState] = Recoil_index_22(RaytracerRunningState);
  React.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "gui", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      NumberInput,
      {
        label: "Image width:",
    ...
    raytracerState.webGPUenabled === false ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      NumberInput,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "resetButton", onClick: onResetClicked, children: "Reset to default" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "renderButton", onClick: onStartRenderClicked, children: raytracerRunningState.isRunning ? "Stop rendering!" : "Start rendering!" })
  ] });
};
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Gui, {}),
...
root.render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(Recoil_index_5, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) })
);
